      ...
      <div className="bg-white p-6 rounded-lg shadow-md mb-8">
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input type="text" name="contact_person" value={formState.contact_person} onChange={handleInputChange} />
          </div>
          <div>
          ...
          <div>
            ...
            <select name="price_level" value={formState.price_level} onChange={handleInputChange}>
          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Price Level</th>
              </tr>
            </thead>
            <tbody className="bg-white divide-y divide-gray-200">
              {clients.map(client => (
                <tr key={client.id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">{client.price_level}</td>
                </tr>
              ))}
            </tbody>
          </table>
